...
@EnableJpaRepositories("com.icc.repository")
    ...
    public SessionFactory createAndGetLocalSessionFactoryBean() {
        if (this.sessionFactory == null) {
            try {
                ...
                configuration.addPackage("com.icc.model");
                for (Class<?> clazz : (new Reflections("com.icc.model")).getTypesAnnotatedWith(Entity.class)) {
